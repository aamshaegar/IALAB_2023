...
; ###############################################################
; ####### REGOLE DI INFERENZA PER LE CELLE INIZIALI #############
; ###############################################################
...
; Regola per fare guess sulle celle aventi valore di guess_cf più alto. 
(defrule do_guess
...
; L'agente termina la partita solo quando a finito tutte le mosse guess a disposizione.
(defrule do_solve
    (status (step ?s)(currently running))
	(moves (guesses 0))
=>
